...
class CollectionManager {
     ...
     */
    async add<T = Data>(data: Arg<T>, id_gen: boolean = true) {
     ...
     */
    async find<T = Data>(search: Search<T>, context: VContext = {}, options: DbFindOpts<T> = {}, findOpts: FindOpts<T> = {}) {
     ...
     */
    async findOne<T = Data>(search: Search<T>, context: VContext = {}, findOpts: FindOpts<T> = {}) {
     ...
     */
    async update<T = Data>(search: Search<T>, updater: Updater<T>, context: VContext = {}) {
     ...
     */
    async updateOne<T = Data>(search: Search<T>, updater: Updater<T>, context: VContext = {}) {
     ...
     */
    async remove<T = Data>(search: Search<T>, context: VContext = {}) {
     ...
     */
    async removeOne<T = Data>(search: Search<T>, context: VContext = {}) {
     ...
     */
    async updateOneOrAdd<T = Data>(search: Search<T>, updater: Updater<T>, add_arg: Arg<T> = {}, context: VContext = {}, id_gen: boolean = true) {
