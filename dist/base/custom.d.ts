...
export declare abstract class CustomActionsBase extends ActionsBase {
     ...
     */
    update(query: VQueryT.Update): Promise<import("../types/data.js").DataInternal[]>;
    /**
     * Update the first matching entry in the specified database based on search criteria and an updater function or object.
     */
    updateOne(query: VQueryT.Update): Promise<import("../types/data.js").DataInternal>;
    /**
     * Remove entries from the specified database based on search criteria.
     */
    remove(query: VQueryT.Remove): Promise<import("../types/data.js").DataInternal[]>;
    /**
     * Remove the first matching entry from the specified database based on search criteria.
     */
    removeOne(query: VQueryT.Remove): Promise<import("../types/data.js").DataInternal>;
}
